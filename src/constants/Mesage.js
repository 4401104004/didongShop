...
export const MSG_UPDATE_CART_SECCESS ='Cập nhật giỏ hàng thành công !';
export const MSG_DELETE_PRODUCT_IN_CART_SECCESS ='Xoá sản phẩm khỏi giỏ hàng thành công !';
